...
module.exports = {
    ...
    .addStringOption(option =>
		  option.setName('interwiki')
			  .setDescription('Optional interwiki link. The end colon ":" is not needed.')
    )
    .addStringOption(option =>
    ...
    await interaction.reply(`https://c.fandom.com/wiki/${interwikiLink}:${inputLink}${pageAction}`)
