        ...
        async (quote) => {
          ...
          if (
            ...
            !(
              quote.member.nickname
                .toLowerCase()
                .includes(quote.author.username.toLowerCase()) ||
          ...
          let embed = new MessageEmbed()
            ...
            .setAuthor({
              name: quoteAuthor,
              iconURL: (quote.member || quote.author).displayAvatarURL(
                imageOptions
              ),
            })
            .setFooter(quotedBy, message.member.displayAvatarURL(imageOptions))
              ...
              .forEach((msgEmbed) => {
                files.unshift(
                  new MessageAttachment(
                    msgEmbed.video?.url || msgEmbed.thumbnail?.url
                  )
                );
              });
          }
